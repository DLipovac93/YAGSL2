...
public class RobotContainer {
  ...
  Joystick driverJoystickController = new Joystick(0);
  ...
  public RobotContainer() {
    ...
    AbsoluteDrive closedAbsoluteDrive = new AbsoluteDrive(drivebase,
                                                          ...
                                                          () -> MathUtil.applyDeadband(driverJoystickController.getLeftY(),
                                                                                       OperatorConstants.LEFT_Y_DEADBAND),
                                                          () -> MathUtil.applyDeadband(driverJoystickController.getLeftX(),
                                                                                       OperatorConstants.LEFT_X_DEADBAND),
                                                          () -> -driverJoystickController.getRightX(),
                                                          () -> -driverJoystickController.getRightY());
